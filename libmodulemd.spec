...
Version  : 2.15.1
Release  : 46
URL      : https://github.com/fedora-modularity/libmodulemd/releases/download/2.15.1/modulemd-2.15.1.tar.xz
Source0  : https://github.com/fedora-modularity/libmodulemd/releases/download/2.15.1/modulemd-2.15.1.tar.xz
Source1  : https://github.com/fedora-modularity/libmodulemd/releases/download/2.15.1/modulemd-2.15.1.tar.xz.asc
...
%setup -q -n modulemd-2.15.1
cd %{_builddir}/modulemd-2.15.1
pushd ..
cp -a modulemd-2.15.1 buildavx2
popd
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1746800310
...
%files lib
%defattr(-,root,root,-)
/V3/usr/lib64/libmodulemd.so.2.15.1
/usr/lib64/libmodulemd.so.2
/usr/lib64/libmodulemd.so.2.15.1
