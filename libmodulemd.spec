...
%setup -q -n modulemd-2.15.0
cd %{_builddir}/modulemd-2.15.0
pushd ..
cp -a modulemd-2.15.0 buildavx2
popd
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1719428522
...
%files lib
%defattr(-,root,root,-)
/V3/usr/lib64/libmodulemd.so.2.15.0
